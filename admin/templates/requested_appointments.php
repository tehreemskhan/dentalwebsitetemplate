  ...
  <nav class="col-md-2 d-none d-md-block bg-light sidebar">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <h1 class="h2"> Requested Appointments </h1>
      ...
      <?php 
          $query = "SELECT * FROM requested_appointments";
      ...
      <div class="table-responsive">
        ...
        ?>
            ...
            <tr>
              ...
              <td> <a href="approve.php?p_id=<?php echo $id; ?>" class="btn btn-success">Approve</a> </td>

             <td><a href="deny.php?dp_id=<?php echo $id; ?>" class="btn btn-danger"> Deny </a></td>
        ...
        <?php } else {
          echo "<h2>You Have No Pending Appointments</h2>";
        } ?>
